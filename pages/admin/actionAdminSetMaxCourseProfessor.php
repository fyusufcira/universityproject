...
if (isset($_POST['submit'])) {
    ...
    //updating max course professsor

    $sql_2 = "UPDATE rules
        	          SET max_course_professor=$maxCourse ";
...
<div class="wrapper" style="width: 500px; margin-top:20px;!important;">
    ...
    <form action="actionAdminSetMaxCourseProfessor.php" method="post">
...
padding: 10px">
            Enter the number of maximum course number that is approved for professors
        </p>
        ...
        <div class="field">
            ...
            <label>Maximum Course Approved for Professors</label>
        </div>


        <div class="field">
            <input type="submit" value="Set Maximum Course for Professor " name="submit">
        </div>
    </form>
</div>
</body>
