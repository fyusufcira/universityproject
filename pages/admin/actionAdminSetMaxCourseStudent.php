...
if (isset($_POST['submit'])) {
    ...
    //updating max course student
    $sql_2 = "UPDATE rules
        	          SET max_course_student=$maxCourse ";
...
<div class="wrapper" style="width: 500px; margin-top:20px;!important;">
    ...
    <form action="actionAdminSetMaxCourseStudent.php" method="post">
...
padding: 10px">
            Enter the number of maximum course number that is approved for students
        </p>
        ...
        <div class="field">
            ...
            <label>Maximum Course Approved for Students</label>
        </div>


        <div class="field">
            <input type="submit" value="Set Maximum Course for Student " name="submit">
        </div>
    </form>
</div>
</body>
